...
AnnotatedCameraWidget::AnnotatedCameraWidget(VisionStreamType type, QWidget* parent) : fps_filter(UI_FREQ, 3, 1. / UI_FREQ), CameraWidget("camerad", type, true, parent) {
  ...
  themeConfiguration = {
    ...
    {9, {QString("enchantedforest"), {QColor(0, 51, 0, 255), {{0.0, QBrush(QColor(0, 51, 0, 255))}, {0.2, QBrush(QColor(0, 102, 0, 255))}, {0.4, QBrush(QColor(0, 51, 0, 255))}, {0.6, QBrush(QColor(0, 102, 0, 255))}, {0.8, QBrush(QColor(0, 51, 0, 255))}, {1.0, QBrush(QColor(0, 51, 0, 255))}}}}},
