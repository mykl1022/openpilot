...
void AnnotatedCameraWidget::drawLaneLines(QPainter &painter, const UIState *s) {
  ...
  if (alwaysOnLateral) {
    pe.setColorAt(0.0, QColor::fromHslF(0 / 360., 1.0, 1.0, 1.0));
    pe.setColorAt(0.5, QColor::fromHslF(0 / 360., 1.0, 1.0, 0.5));
    pe.setColorAt(1.0, QColor::fromHslF(0 / 360., 1.0, 1.0, 0.1));
