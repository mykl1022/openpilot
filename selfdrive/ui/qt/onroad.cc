...
void AnnotatedCameraWidget::initializeFrogPilotWidgets() {
  ...
  themeConfiguration = {
   ...
   {20, {"new_theme", 4, QColor(90, 0, 169, 155), {{0.1, QBrush(QColor(37, 0, 51, 255))}, 
    ...
    {22, {"rev1_theme", 4, QColor(242, 255, 0, 255), {{0.0, QBrush(QColor(242, 255, 0, 255))}, 
                                                  {0.6, QBrush(QColor(170, 255, 0, 255))}, 
                                                  {0.76, QBrush(QColor(170, 255, 0, 255))}, 
                                                  {0.8, QBrush(QColor(242, 255, 0, 255))}, 
                                                  {1.0, QBrush(QColor(170, 255, 0, 255))}}}},

    {23, {"rev2_theme", 4, QColor(40, 150, 90, 255), {{0.0, QBrush(QColor(42, 96, 65, 255))}, 
                                                   {0.6, QBrush(QColor(44, 234, 163, 255))}, 
                                                   {0.7, QBrush(QColor(107, 255, 184, 255))},
                                                   {0.8, QBrush(QColor(124, 254, 240, 255))},
                                                   {1.0, QBrush(QColor(44, 234, 163, 255))}}}},

    {24, {"rev3_theme", 6, QColor(255, 73, 225, 255), {{0.0, QBrush(QColor(255, 155, 238, 255))}, 
                                                   {0.4, QBrush(QColor(255, 199, 245, 255))}, 
                                                   {0.73, QBrush(QColor(255, 155, 238, 255))},
                                                   {0.9, QBrush(QColor(255, 0, 212, 255))},
                                                   {0.99, QBrush(QColor(255, 155, 238, 255))},
                                                   {1.0, QBrush(QColor(255, 0, 212, 255))}}}},

    {25, {"rev4_theme", 4, QColor(48, 37, 91, 255), {{0.0, QBrush(QColor(252, 159, 50, 255))}, 
                                                {0.4, QBrush(QColor(100, 33, 66, 255))}, 
                                                {0.7, QBrush(QColor(252, 159, 50, 255))}, 
                                                {0.8, QBrush(QColor(174, 27, 30, 255))}, 
                                                {1.0, QBrush(QColor(26, 39, 102, 255))}}}},

    {26, {"rev5_theme", 4, QColor(0, 140, 255, 255), {{0.0, QBrush(QColor(255, 53, 235, 255))}, 
                                                   {0.4, QBrush(QColor(0, 0, 0, 255))}, 
                                                   {0.73, QBrush(QColor(104, 227, 249, 255))},
                                                   {0.9, QBrush(QColor(255, 53, 235, 255))},
                                                   {1.0, QBrush(QColor(90, 0, 169, 255))}}}},

    {27, {"rev6_theme", 6, QColor(255, 175, 244, 255), {{0.0, QBrush(QColor(255, 175, 244, 255))}, 
                                                  {0.2, QBrush(QColor(255, 240, 163, 255))}, 
                                                  {0.35, QBrush(QColor(255, 247, 0, 255))}, 
                                                  {0.5, QBrush(QColor(255, 180, 238, 255))},
                                                  {0.6, QBrush(QColor(255, 241, 203, 255))},
                                                  {0.7, QBrush(QColor(255, 221, 0, 255))},
                                                  {1.0, QBrush(QColor(115, 0, 255, 255))}}}},
    ...
    {29, {"rev8_theme", 4, QColor(52, 7, 61, 255), {{0.0, QBrush(QColor(52, 7, 61, 255))}, 
                                               {0.4, QBrush(QColor(189, 87, 84, 255))}, 
                                               {0.6, QBrush(QColor(148, 63, 77, 255))},
                                               {0.7, QBrush(QColor(101, 35, 69, 255))},
                                               {0.8, QBrush(QColor(77, 21, 65, 255))},
                                               {1.0, QBrush(QColor(239, 116, 92, 255))}}}},

    {30, {"rev9_theme", 6, QColor(255, 255, 255, 255), {{0.0, QBrush(QColor(255, 255, 255, 255))}, 
                                                    {0.6, QBrush(QColor(70, 185, 196, 255))}, 
                                                    {0.7, QBrush(QColor(92, 218, 215, 255))},
                                                    {0.8, QBrush(QColor(49, 152, 177, 255))},
                                                    {1.0, QBrush(QColor(255, 255, 255, 255))}}}},

    {31, {"rev10_theme", 4, QColor(0, 0, 0, 255), {{0.0, QBrush(QColor(0, 0, 0, 255))},
                                                   {0.4, QBrush(QColor(118, 44, 255, 255))},
                                                   {0.6, QBrush(QColor(0, 229, 255, 255))},
                                                   {0.7, QBrush(QColor(25, 0, 255, 255))},
                                                   {0.8, QBrush(QColor(20, 0, 117, 255))},
                                                   {1.0, QBrush(QColor(25, 0, 255, 255))}}}},

    {32, {"rev11_theme", 4, QColor(255, 255, 255, 255), {{0.0, QBrush(QColor(255, 255, 255, 255))},
                                                    {0.4, QBrush(QColor(255, 253, 203, 255))},
                                                    {0.6, QBrush(QColor(255, 208, 0, 255))},
                                                    {0.7, QBrush(QColor(255, 247, 0, 255))},
                                                    {0.8, QBrush(QColor(118, 118, 0, 255))},
                                                    {1.0, QBrush(QColor(255, 237, 0, 255))}}}},

    {33, {"rev12_theme", 6, QColor(0, 44, 39, 255), {{0.0, QBrush(QColor(0, 44, 39, 255))},
                                                 {0.17, QBrush(QColor(14, 132, 118, 255))},
                                                 {0.50, QBrush(QColor(13, 73, 66, 255))},
                                                 {0.71, QBrush(QColor(179, 141, 64, 255))},
                                                 {0.72, QBrush(QColor(255, 255, 255, 255))},
                                                 {0.75, QBrush(QColor(179, 141, 64, 255))},
                                                 {1.0, QBrush(QColor(3, 30, 27, 255))}}}},

    {34, {"rev13_theme", 4, QColor(42, 96, 65, 255), {{0.0, QBrush(QColor(42, 96, 65, 255))}, 
                                                  {0.6, QBrush(QColor(40, 150, 90, 255))}, 
                                                  {0.7, QBrush(QColor(44, 234, 163, 255))},
                                                  {0.8, QBrush(QColor(107, 255, 184, 255))},
                                                  {1.0, QBrush(QColor(124, 254, 240, 255))}}}},
                                                  
    {35, {"rev14_theme", 4, QColor(0, 0, 0, 255), {{0.0, QBrush(QColor(0, 0, 0, 255))}, 
                                                {0.55, QBrush(QColor(255, 238, 0, 255))},
                                                {0.6, QBrush(QColor(252, 255, 154, 255))},
                                                {0.65, QBrush(QColor(70, 56, 43, 255))},
                                                {0.70, QBrush(QColor(183, 111, 68, 255))},
                                                {1.0, QBrush(QColor(255, 238, 50, 255))}}}},

    {36, {"rev15_theme", 6, QColor(0, 0, 0, 255), {{0.0, QBrush(QColor(0, 0, 0, 255))}, 
                                                {0.4, QBrush(QColor(115, 0, 0, 255))}, 
                                                {0.5, QBrush(QColor(165, 45, 45, 255))},
                                                {0.6, QBrush(QColor(133, 0, 0, 255))},
                                                {0.7, QBrush(QColor(171, 0, 0, 255))}, 
                                                {0.8, QBrush(QColor(98, 0, 0, 255))},
                                                {1.0, QBrush(QColor(0, 0, 0, 255))}}}},

    {37, {"rev16_theme", 4, QColor(0, 0, 0, 255), {{0.0, QBrush(QColor(0, 0, 0, 255))}, 
                                                {0.52, QBrush(QColor(230, 255, 0, 255))}, 
                                                {0.55, QBrush(QColor(230, 255, 0, 255))},
                                                {0.6, QBrush(QColor(0, 0, 0, 255))},
                                                {0.65, QBrush(QColor(230, 255, 0, 255))}, 
                                                {0.67, QBrush(QColor(230, 255, 0, 255))},
                                                {1.0, QBrush(QColor(230, 255, 0, 255))}}}},

    {38, {"rev17_theme", 4, QColor(34, 0, 66, 255), {{0.0, QBrush(QColor(34, 0, 66, 255))}, 
                                                {0.4, QBrush(QColor(67, 0, 154, 255))}, 
                                                {0.6, QBrush(QColor(102, 0, 255, 255))},
                                                {0.75, QBrush(QColor(98, 0, 255, 255))},
                                                {0.8, QBrush(QColor(53, 0, 73, 255))}, 
                                                {0.85, QBrush(QColor(98, 0, 255, 255))},
                                                {1.0, QBrush(QColor(115, 0, 255, 255))}}}},

    {39, {"rev18_theme", 6, QColor(0, 0, 0, 255), {{0.0, QBrush(QColor(0, 0, 0, 255))}, 
                                               {0.15, QBrush(QColor(0, 0, 0, 255))}, 
                                               {0.2, QBrush(QColor(251, 255, 0, 255))},
                                               {0.25, QBrush(QColor(47, 255, 0, 255))},
                                               {0.3, QBrush(QColor(0, 229, 255, 255))}, 
                                               {0.35, QBrush(QColor(102, 0, 255, 255))},
                                               {0.4, QBrush(QColor(255, 0, 212, 255))},
                                               {0.45, QBrush(QColor(255, 0, 0, 255))},
                                               {0.55, QBrush(QColor(255, 0, 0, 255))}, 
                                               {0.6, QBrush(QColor(255, 0, 212, 255))},
                                               {0.65, QBrush(QColor(0, 229, 255, 255))},
                                               {0.7, QBrush(QColor(102, 0, 255, 255))}, 
                                               {0.75, QBrush(QColor(47, 255, 0, 255))},
                                               {0.8, QBrush(QColor(251, 255, 0, 255))},
                                               {0.85, QBrush(QColor(0, 0, 0, 255))},
                                               {1.0, QBrush(QColor(0, 0, 0, 255))}}}},
