...
void AnnotatedCameraWidget::drawLaneLines(QPainter &painter, const UIState *s) {
  ...
  if (alwaysOnLateral) {
    pe.setColorAt(0.0, QColor::fromHslF(30 / 360., 1.0, 0.5, 1.0));
    pe.setColorAt(0.5, QColor::fromHslF(30 / 360., 1.0, 0.0, 0.5));
    pe.setColorAt(1.0, QColor::fromHslF(30 / 360., 1.0, 0.00, 0.1));
