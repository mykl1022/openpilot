...
void AnnotatedCameraWidget::initializeFrogPilotWidgets() {
  ...
  themeConfiguration = {
    ...
    {4, {"mercury_theme", 4, QColor(0, 0, 0, 155), {{0.0, QBrush(QColor::fromHslF(223 / 360., 1.0, 0.0, 0.9))},
                                                     ...
                                                     {0.4, QBrush(QColor::fromHslF(45 / 360., 1.0, 0.65, 1.0))},
                                                     {0.5, QBrush(QColor::fromHslF(40 / 360., 1.0, 0.79, 1.0))},
    ...
    {5, {"jupiter_theme", 6, QColor(255, 0, 0, 255), {{0.0, QBrush(QColor::fromHslF(196 / 360., 0.38, 0.94, 1.0))},
                                                      {0.1, QBrush(QColor::fromHslF(43 / 360., 0.3, 0.84, 1.0))},
                                                      {0.15, QBrush(QColor::fromHslF(46 / 360., 0.43, 0.73, 1.0))},
                                                      {0.2, QBrush(QColor::fromHslF(21 / 360., 0.15, 0.59, 1.0))},
                                                      {0.25, QBrush(QColor::fromHslF(36 / 360., 0.57, 0.51, 1.0))},
                                                      {0.3, QBrush(QColor::fromHslF(196 / 360., 0.38, 0.94, 1.0))},
                                                      {0.35, QBrush(QColor::fromHslF(43 / 360., 0.3, 0.84, 1.0))},
                                                      {0.4, QBrush(QColor::fromHslF(46 / 360., 0.43, 0.73, 1.0))},
                                                      {0.45, QBrush(QColor::fromHslF(196 / 360., 0.38, 0.94, 1.0))},
                                                      {0.5, QBrush(QColor::fromHslF(43 / 360., 0.3, 0.84, 1.0))},
                                                      {0.55, QBrush(QColor::fromHslF(46 / 360., 0.43, 0.73, 1.0))},
                                                      {0.6, QBrush(QColor::fromHslF(21 / 360., 0.15, 0.59, 1.0))},
                                                      {0.65, QBrush(QColor::fromHslF(36 / 360., 0.57, 0.51, 1.0))},
                                                      {0.7, QBrush(QColor::fromHslF(196 / 360., 0.38, 0.94, 1.0))},
                                                      {0.75, QBrush(QColor::fromHslF(43 / 360., 0.3, 0.84, 1.0))},
