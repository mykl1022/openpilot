...
AnnotatedCameraWidget::AnnotatedCameraWidget(VisionStreamType type, QWidget* parent) : fps_filter(UI_FREQ, 3, 1. / UI_FREQ), CameraWidget("camerad", type, true, parent) {
  ...
  themeConfiguration = {
    ...
    {4, {QString("galaxy_theme"), {QColor(0, 0, 51, 255), {{0.0, QBrush(QColor(0, 0, 51, 255))},
                                                           {0.2, QBrush(QColor(15, 0, 51, 255))},
                                                           {0.4, QBrush(QColor(25, 0, 102, 255))},
                                                           {0.6, QBrush(QColor(5, 0, 25, 255))},
                                                           {0.8, QBrush(QColor(0, 0, 51, 255))},
                                                           {1.0, QBrush(QColor(0, 0, 51, 255))}}}}},
