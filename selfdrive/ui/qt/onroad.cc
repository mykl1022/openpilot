...
AnnotatedCameraWidget::AnnotatedCameraWidget(VisionStreamType type, QWidget* parent) : fps_filter(UI_FREQ, 3, 1. / UI_FREQ), CameraWidget("camerad", type, true, parent) {
  ...
  themeConfiguration = {
    ...
    {26, {QString("hauntedhouse"), {QColor(102, 0, 153, 255), {{0.0, QBrush(QColor(102, 0, 153, 255))}, {0.2, QBrush(QColor(153, 0, 204, 255))}, {0.4, QBrush(QColor(102, 0, 153, 255))}, {0.6, QBrush(QColor(153, 0, 204, 255))}, {0.8, QBrush(QColor(102, 0, 153, 255))}, {1.0, QBrush(QColor(102, 0, 153, 255))}}}}},
