...
AnnotatedCameraWidget::AnnotatedCameraWidget(VisionStreamType type, QWidget* parent) : fps_filter(UI_FREQ, 3, 1. / UI_FREQ), CameraWidget("camerad", type, true, parent) {
  ...
  themeConfiguration = {
    ...
    {10, {QString("Heat"), {QColor(255, 0, 0, 255), {{0.0, QBrush(QColor(85, 0, 150, 255))}, {0.2, QBrush(QColor(102, 0, 0, 255))}, {0.4, QBrush(QColor(204, 0, 0, 255))}, {0.6, QBrush(QColor(255, 102, 0, 255))}, {0.8, QBrush(QColor(255, 0, 0, 255))}, {1.0, QBrush(QColor(85, 0, 150, 255))}}}}},
    ...
    {12, {QString("pool"), {QColor(255, 85, 85, 255), {{0.0, QBrush(QColor(0, 0, 0, 255))}, {0.2, QBrush(QColor(0, 85, 90, 255))}, {0.4, QBrush(QColor(0, 250, 250, 255))}, {0.6, QBrush(QColor(255, 255, 255, 255))}, {0.8, QBrush(QColor(0, 85, 90, 255))}, {1.0, QBrush(QColor(0, 0, 0, 255))}}}}},
    {13, {QString("desert"), {QColor(215, 190, 55, 255), {{0.0, QBrush(QColor(0, 0, 0, 255))}, {0.2, QBrush(QColor(71, 46, 0, 255))}, {0.4, QBrush(QColor(255, 250, 138, 255))}, {0.6, QBrush(QColor(255, 211, 78, 255))}, {0.8, QBrush(QColor(255, 219, 147, 255))}, {1.0, QBrush(QColor(83, 73, 29, 255))}}}}},
    {14, {QString("Brite"), {QColor(255, 255, 0, 255), {{0.0, QBrush(QColor(118, 199, 199, 255))}, {0.2, QBrush(QColor(0, 255, 200, 255))}, {0.4, QBrush(QColor(255, 255, 0, 255))}, {0.6, QBrush(QColor(36, 242, 253, 255))}, {0.8, QBrush(QColor(0, 161, 206, 255))}, {1.0, QBrush(QColor(230, 255, 0, 255))}}}}},
    {15, {QString("SunUp"), {QColor(64, 236, 255, 255), {{0.0, QBrush(QColor(123, 0, 255, 255))}, {0.2, QBrush(QColor(13, 0, 98, 255))}, {0.4, QBrush(QColor(231, 113, 23, 255))}, {0.6, QBrush(QColor(255, 255, 160, 255))}, {0.8, QBrush(QColor(64, 236, 255, 255))}, {1.0, QBrush(QColor(0, 64, 117, 255))}}}}},
    {16, {QString("volcanotrail"), {QColor(51, 0, 0, 255), {{0.0, QBrush(QColor(102, 0, 0, 255))}, {0.2, QBrush(QColor(204, 0, 0, 255))}, {0.4, QBrush(QColor(255, 51, 0, 255))}, {0.6, QBrush(QColor(204, 0, 0, 255))}, {0.8, QBrush(QColor(102, 0, 0, 255))}, {1.0, QBrush(QColor(51, 0, 0, 255))}}}}},
