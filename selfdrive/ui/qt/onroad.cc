...
AnnotatedCameraWidget::AnnotatedCameraWidget(VisionStreamType type, QWidget* parent) : fps_filter(UI_FREQ, 3, 1. / UI_FREQ), CameraWidget("camerad", type, true, parent) {
  ...
  themeConfiguration = {
    {1, {QString("pika_theme"), {QColor(129, 0, 204, 255), {{0.0, QBrush(QColor::fromHslF(59 / 360., 1.0, 0.5, 1.0))}, {0.2, QBrush(QColor::fromHslF(59 / 360., 1.0, 0.5, 1.0))}, {0.4, QBrush(QColor::fromHslF(59 / 360., 1.0, 0.0, 1.0))}, {0.6, QBrush(QColor::fromHslF(59 / 360., 1.0, 0.5, 1.0))}, {0.8, QBrush(QColor::fromHslF(350 / 360., 1.0, 0.5, 1.0))}, {1.0, QBrush(QColor::fromHslF(59 / 360., 1.0, 0.5, 1.0))}}}}},
