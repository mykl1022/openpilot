...
AnnotatedCameraWidget::AnnotatedCameraWidget(VisionStreamType type, QWidget* parent) : fps_filter(UI_FREQ, 3, 1. / UI_FREQ), CameraWidget("camerad", type, true, parent) {
  ...
  themeConfiguration = {
    ...
    {17, {QString("beach"), {QColor(255, 0, 0, 255), {{0.0, QBrush(QColor(131, 35, 136, 255))}, {0.2, QBrush(QColor(227, 67, 107, 255))}, {0.4, QBrush(QColor(240, 119, 47, 255))}, {0.6, QBrush(QColor(131, 35, 136, 255))}, {0.8, QBrush(QColor(227, 67, 107, 255))}, {1.0, QBrush(QColor(240, 119, 47, 255))}}}}},
