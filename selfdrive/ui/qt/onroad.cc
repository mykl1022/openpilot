...
void AnnotatedCameraWidget::initializeFrogPilotWidgets() {
  ...
  themeConfiguration = {
    {1, {"frog_theme", QColor(23, 134, 68, 242), {{0.0, QBrush(QColor::fromHslF(81 / 360., 1.0, 0.5, 0.9))},
                                                  {0.5, QBrush(QColor::fromHslF(81 / 360., 1.0, 0.5, 0.5))},
                                                  {1.0, QBrush(QColor::fromHslF(81 / 360., 1.0, 0.0, 0.1))}}}},
