...
void AnnotatedCameraWidget::initializeFrogPilotWidgets() {
  ...
  themeConfiguration = {
    {1, {"frog_theme", QColor(170, 255, 0, 255), {{0.0, QBrush(QColor(170, 255, 0, 255))}, 
    ...
    {2, {"tesla_theme", QColor(44, 234, 163, 255), {{0.0, QBrush(QColor(124, 254, 240, 255))}, 
    ...
    {3, {"stalin_theme", QColor(171, 0, 0, 255), {{0.0, QBrush(QColor(0, 0, 0, 255))}, 
   ...
   {4, {"dusk_theme", QColor(252, 159, 50, 155), {{0.0, QBrush(QColor(26, 39, 102, 255))}, 
   ...
   {5, {"hs&hrs_theme", QColor(90, 0, 169, 155), {{0.1, QBrush(QColor(104, 227, 249, 255))}, 
   ...
   {6, {"opal_theme", QColor(115, 0, 255, 155), {{0.0, QBrush(QColor(115, 0, 255, 255))}, 
   ...
   {7, {"comic_theme", QColor(255, 255, 255, 155), {{0.0, QBrush(QColor(255, 255, 255, 255))}, 
   ...
   {8, {"dawn_theme", QColor(239, 116, 92, 155), {{0.0, QBrush(QColor(239, 116, 92, 255))}, 
   ...
   {9, {"freeze_theme", QColor(92, 218, 215, 255), {{0.0, QBrush(QColor(255, 255, 255, 255))}, 
                                                           {0.2, QBrush(QColor(49, 152, 177, 255))}, 
                                                           {0.3, QBrush(QColor(92, 218, 215, 255))},
                                                           {0.4, QBrush(QColor(70, 185, 196, 255))},
                                                           {1.0, QBrush(QColor(255, 255, 255, 255))}}}},

   {10, {"midnight_theme", QColor(118, 44, 255, 255), {{0.0, QBrush(QColor(25, 0, 255, 255))},
   ...
   {11, {"gold_theme", QColor(255, 253, 203, 255), {{0.0, QBrush(QColor(255, 237, 0, 255))},
   ...
   {12, {"jade_theme", QColor(179, 141, 64, 255), {{0.0, QBrush(QColor(3, 30, 27, 255))},
   ...
   {13, {"baja_theme", QColor(44, 234, 163, 255), {{0.0, QBrush(QColor(124, 254, 240, 255))}, 
                                                           {0.2, QBrush(QColor(107, 255, 184, 255))}, 
                                                           {0.3, QBrush(QColor(44, 234, 163, 255))},
                                                           {0.4, QBrush(QColor(40, 150, 90, 255))},
                                                           {1.0, QBrush(QColor(42, 96, 65, 255))}}}},
                                                          
   {14, {"torch_theme", QColor(255, 238, 50, 255), {{0.0, QBrush(QColor(183, 111, 68, 255))}, 
   ...
   {15, {"blood_theme", QColor(171, 0, 0, 255), {{0.0, QBrush(QColor(0, 0, 0, 255))}, 
                                                           {0.2, QBrush(QColor(98, 0, 0, 255))}, 
                                                           {0.3, QBrush(QColor(171, 0, 0, 255))},
                                                           {0.4, QBrush(QColor(133, 0, 0, 255))},
                                                           {0.5, QBrush(QColor(165, 45, 45, 255))}, 
   ...
   {16, {"bumble_theme", QColor(230, 255, 0, 255), {{0.0, QBrush(QColor(230, 255, 0, 255))}, 
   ...
   {17, {"purp_theme", QColor(98, 0, 255, 255), {{0.0, QBrush(QColor(115, 0, 255, 255))}, 
   ...
   {18, {"mario_theme", QColor(255, 255, 255, 255), {{0.1, QBrush(QColor(0, 0, 0, 255))}, 
   ...
   {19, {"ghost_theme", QColor(165, 165, 165, 40), {{0.3, QBrush(QColor(0, 0, 0, 90))}, 
                                                           {0.4, QBrush(QColor(165, 165, 165, 90))},
                                                           {0.6, QBrush(QColor(0, 0, 0, 90))},
                                                           {0.95, QBrush(QColor(255, 255, 255, 90))}}}},
   
   {20, {"new_theme", QColor(90, 0, 169, 155), {{0.1, QBrush(QColor(37, 0, 51, 255))}, 
							                                            {0.27, QBrush(QColor(0, 0, 0, 255))}, 
