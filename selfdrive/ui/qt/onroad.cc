...
AnnotatedCameraWidget::AnnotatedCameraWidget(VisionStreamType type, QWidget* parent) : fps_filter(UI_FREQ, 3, 1. / UI_FREQ), CameraWidget("camerad", type, true, parent) {
  ...
  themeConfiguration = {
    ...
    {10, {QString("lavaflow"), {QColor(255, 0, 0, 255), {{0.0, QBrush(QColor(51, 0, 0, 255))}, {0.2, QBrush(QColor(102, 0, 0, 255))}, {0.4, QBrush(QColor(204, 0, 0, 255))}, {0.6, QBrush(QColor(255, 102, 0, 255))}, {0.8, QBrush(QColor(255, 0, 0, 255))}, {1.0, QBrush(QColor(255, 0, 0, 255))}}}}},
    {11, {QString("underwateradventure"), {QColor(0, 102, 102, 255), {{0.0, QBrush(QColor(0, 51, 102, 255))}, {0.2, QBrush(QColor(0, 102, 204, 255))}, {0.4, QBrush(QColor(0, 102, 204, 255))}, {0.6, QBrush(QColor(0, 51, 102, 255))}, {0.8, QBrush(QColor(0, 102, 102, 255))}, {1.0, QBrush(QColor(0, 102, 102, 255))}}}}},
    {12, {QString("candyland"), {QColor(255, 85, 85, 255), {{0.0, QBrush(QColor(255, 85, 85, 255))}, {0.2, QBrush(QColor(255, 170, 85, 255))}, {0.4, QBrush(QColor(255, 255, 85, 255))}, {0.6, QBrush(QColor(170, 85, 255, 255))}, {0.8, QBrush(QColor(85, 85, 255, 255))}, {1.0, QBrush(QColor(85, 85, 255, 255))}}}}},
    {14, {QString("icepalace"), {QColor(204, 229, 255, 255), {{0.0, QBrush(QColor(204, 229, 255, 255))}, {0.2, QBrush(QColor(153, 204, 255, 255))}, {0.4, QBrush(QColor(102, 153, 255, 255))}, {0.6, QBrush(QColor(204, 229, 255, 255))}, {0.8, QBrush(QColor(153, 204, 255, 255))}, {1.0, QBrush(QColor(204, 229, 255, 255))}}}}},
    {15, {QString("hauntedforest"), {QColor(51, 0, 51, 255), {{0.0, QBrush(QColor(0, 0, 0, 255))}, {0.2, QBrush(QColor(102, 0, 102, 255))}, {0.4, QBrush(QColor(51, 0, 51, 255))}, {0.6, QBrush(QColor(102, 0, 102, 255))}, {0.8, QBrush(QColor(51, 0, 51, 255))}, {1.0, QBrush(QColor(0, 0, 0, 255))}}}}},
    ...
    {18, {QString("goldenroad"), {QColor(255, 215, 0, 255), {{0.0, QBrush(QColor(255, 255, 255, 255))}, {0.1, QBrush(QColor(245, 225, 50, 255))}, {0.2, QBrush(QColor(255, 215, 0, 255))}, {0.3, QBrush(QColor(245, 225, 50, 255))}, {0.4, QBrush(QColor(255, 215, 0, 255))}, {0.5, QBrush(QColor(245, 225, 50, 255))}, {0.6, QBrush(QColor(255, 215, 0, 255))}, {0.7, QBrush(QColor(245, 225, 50, 255))}, {0.8, QBrush(QColor(255, 215, 0, 255))}, {0.9, QBrush(QColor(245, 225, 50, 255))}, {1.0, QBrush(QColor(255, 215, 0, 255))}}}}},
    ...
    {20, {QString("sherbetsunrise"), {QColor(255, 153, 102, 255), {{0.0, QBrush(QColor(255, 153, 102, 255))}, {0.2, QBrush(QColor(255, 187, 153, 255))}, {0.4, QBrush(QColor(255, 221, 187, 255))}, {0.6, QBrush(QColor(255, 187, 153, 255))}, {0.8, QBrush(QColor(255, 153, 102, 255))}, {1.0, QBrush(QColor(255, 153, 102, 255))}}}}},
    {21, {QString("ancientruins"), {QColor(165, 140, 125, 255), {{0.0, QBrush(QColor(165, 140, 125, 255))}, {0.2, QBrush(QColor(155, 135, 120, 255))}, {0.4, QBrush(QColor(145, 130, 115, 255))}, {0.6, QBrush(QColor(155, 135, 120, 255))}, {0.8, QBrush(QColor(165, 140, 125, 255))}, {1.0, QBrush(QColor(165, 140, 125, 255))}}}}},
