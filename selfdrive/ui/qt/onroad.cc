...
AnnotatedCameraWidget::AnnotatedCameraWidget(VisionStreamType type, QWidget* parent) : fps_filter(UI_FREQ, 3, 1. / UI_FREQ), CameraWidget("camerad", type, true, parent) {
  ...
  themeConfiguration = {
    ...
    {7, {QString("Solar"), {QColor(255, 208, 0, 255), {{0.0, QBrush(QColor::fromHslF(0 / 360., 0.0, 0.0, 1.0))}, {0.2, QBrush(QColor::fromHslF(34 / 360., 1.0, 0.5, 1.0))}, {0.4, QBrush(QColor::fromHslF(49 / 360., 1.0, 0.5, 1.0))}, {0.6, QBrush(QColor::fromHslF(34 / 360., 1.0, 0.5, 1.0))}, {0.8, QBrush(QColor::fromHslF(49 / 360., 1.0, 0.5, 1.0))}, {1.0, QBrush(QColor::fromHslF(32 / 360., 0.71, 0.96, 1.0))}}}}},
