...
ExperimentalButton::ExperimentalButton(QWidget *parent) : experimental_mode(false), engageable(false), QPushButton(parent), scene(uiState()->scene) {
  ...
  wheelImages = {
    ...
    {6, loadPixmap("../frogpilot/assets/wheel_images/kirby.png", {img_size, img_size})},
    {7, loadPixmap("../frogpilot/assets/random_events/images/firefox.png", {img_size, img_size})},
    {8, loadPixmap("../frogpilot/assets/wheel_images/dusk.png", {img_size, img_size})},
    {9, loadPixmap("../frogpilot/assets/wheel_images/hs&hrs.png", {img_size, img_size})},
    {10, loadPixmap("../frogpilot/assets/wheel_images/comic.png", {img_size, img_size})},
    {11, loadPixmap("../frogpilot/assets/wheel_images/dawn.png", {img_size, img_size})},
    {12, loadPixmap("../frogpilot/assets/wheel_images/freeze.png", {img_size, img_size})},
    {13, loadPixmap("../frogpilot/assets/wheel_images/midnight.png", {img_size, img_size})},
    {14, loadPixmap("../frogpilot/assets/wheel_images/gold.png", {img_size, img_size})},
    {15, loadPixmap("../frogpilot/assets/wheel_images/jade.png", {img_size, img_size})},
    {16, loadPixmap("../frogpilot/assets/wheel_images/baja.png", {img_size, img_size})},
    {17, loadPixmap("../frogpilot/assets/wheel_images/torch.png", {img_size, img_size})},
    {18, loadPixmap("../frogpilot/assets/wheel_images/blood.png", {img_size, img_size})},
    {19, loadPixmap("../frogpilot/assets/wheel_images/bumble.png", {img_size, img_size})},
    {20, loadPixmap("../frogpilot/assets/wheel_images/purp.png", {img_size, img_size})},
    {21, loadPixmap("../frogpilot/assets/wheel_images/mario.png", {img_size, img_size})},
    {22, loadPixmap("../frogpilot/assets/wheel_images/ghost.png", {img_size, img_size})}
  };
}
...
void ExperimentalButton::paintEvent(QPaintEvent *event) {
  ...
  QColor background_color = wheelIcon && !isDown() && engageable ?
      (scene.always_on_lateral_active ? QColor(123, 0, 255, 255) :
      (scene.conditional_status == 1 ? QColor(255, 246, 0, 255) :
      (experimental_mode ? QColor(255, 0, 0, 241) :
...
void AnnotatedCameraWidget::drawLaneLines(QPainter &painter, const UIState *s) {
  ...
  if (scene.blind_spot_path) {
    ...
    if (blindSpotLeft || blindSpotRight) {
      bs.setColorAt(0.0, QColor::fromHslF(283 / 360., 1.0, 0.15, 0.6));
      bs.setColorAt(0.5, QColor::fromHslF(283 / 360., 1.0, 0.35, 0.4));
      bs.setColorAt(1.0, QColor::fromHslF(283 / 360., 1.0, 0.45, 0.2));
    }
...
void AnnotatedCameraWidget::initializeFrogPilotWidgets() {
  ...
  themeConfiguration = {
    {1, {"frog_theme", 4, QColor(170, 255, 0, 255), {{0.0, QBrush(QColor(170, 255, 0, 255))}, 
    ...
    {2, {"tesla_theme", 4, QColor(44, 234, 163, 255), {{0.0, QBrush(QColor(124, 254, 240, 255))}, 
    ...
    {3, {"kirby_theme", 6, QColor(255, 155, 238, 255), {{0.0, QBrush(QColor(255, 0, 212, 255))}, 
                                                           {0.1, QBrush(QColor(255, 155, 238, 255))}, 
                                                           {0.27, QBrush(QColor(255, 199, 245, 255))},
                                                           {0.4, QBrush(QColor(255, 73, 225, 255))},
                                                           {0.6, QBrush(QColor(255, 199, 245, 255))},
                                                           {1.0, QBrush(QColor(255, 155, 238, 255))}}}},
   {4, {"dusk_theme", 4, QColor(252, 159, 50, 155), {{0.0, QBrush(QColor(26, 39, 102, 255))}, 
   ...
   {5, {"hs&hrs_theme", 4, QColor(90, 0, 169, 155), {{0.1, QBrush(QColor(104, 227, 249, 255))}, 
   ...
   {6, {"opal_theme", 6, QColor(115, 0, 255, 155), {{0.0, QBrush(QColor(115, 0, 255, 255))}, 
   ...
   {7, {"comic_theme", 4, QColor(255, 255, 255, 155), {{0.0, QBrush(QColor(255, 255, 255, 255))}, 
   ...
   {8, {"dawn_theme", 4, QColor(239, 116, 92, 155), {{0.0, QBrush(QColor(239, 116, 92, 255))}, 
                                                           {0.2, QBrush(QColor(77, 21, 65, 255))}, 
                                                           {0.3, QBrush(QColor(101, 35, 69, 255))},
                                                           {0.4, QBrush(QColor(148, 63, 77, 255))},
                                                           {0.6, QBrush(QColor(189, 87, 84, 255))},
                                                           {1.0, QBrush(QColor(52, 7, 61, 255))}}}},

   {9, {"freeze_theme", 6, QColor(92, 218, 215, 255), {{0.0, QBrush(QColor(255, 255, 255, 255))}, 
                                                           {0.2, QBrush(QColor(49, 152, 177, 255))}, 
                                                           {0.3, QBrush(QColor(92, 218, 215, 255))},
                                                           {0.4, QBrush(QColor(70, 185, 196, 255))},
                                                           {1.0, QBrush(QColor(255, 255, 255, 255))}}}},

   {10, {"midnight_theme", 4, QColor(118, 44, 255, 255), {{0.0, QBrush(QColor(25, 0, 255, 255))},
   ...
   {11, {"gold_theme", 4, QColor(255, 253, 203, 255), {{0.0, QBrush(QColor(255, 237, 0, 255))},
                                                           {0.2, QBrush(QColor(118, 118, 0, 255))},
                                                           {0.3, QBrush(QColor(255, 247, 0, 255))},
                                                           {0.4, QBrush(QColor(255, 253, 203, 255))},
                                                           {0.6, QBrush(QColor(255, 208, 0, 255))},
                                                           {1.0, QBrush(QColor(255, 255, 255, 255))}}}},

   {12, {"jade_theme", 6, QColor(179, 141, 64, 255), {{0.0, QBrush(QColor(3, 30, 27, 255))},
   ...
   {13, {"baja_theme", 4, QColor(44, 234, 163, 255), {{0.0, QBrush(QColor(124, 254, 240, 255))}, 
                                                           {0.2, QBrush(QColor(107, 255, 184, 255))}, 
                                                           {0.3, QBrush(QColor(44, 234, 163, 255))},
                                                           {0.4, QBrush(QColor(40, 150, 90, 255))},
                                                           {1.0, QBrush(QColor(42, 96, 65, 255))}}}},
                                                          
   {14, {"torch_theme", 4, QColor(255, 238, 50, 255), {{0.0, QBrush(QColor(183, 111, 68, 255))}, 
                                                           {0.30, QBrush(QColor(70, 56, 43, 255))},
   ...
   {15, {"blood_theme", 6, QColor(171, 0, 0, 255), {{0.0, QBrush(QColor(0, 0, 0, 255))}, 
   ...
   {16, {"bumble_theme", 4, QColor(230, 255, 0, 255), {{0.0, QBrush(QColor(230, 255, 0, 255))}, 
   ...
   {17, {"purp_theme", 4, QColor(98, 0, 255, 255), {{0.0, QBrush(QColor(115, 0, 255, 255))}, 
   ...
   {18, {"mario_theme", 6, QColor(255, 255, 255, 255), {{0.1, QBrush(QColor(0, 0, 0, 255))}, 
                                                           {0.15, QBrush(QColor(255, 0, 0, 255))}, 
                                                           {0.2, QBrush(QColor(255, 0, 212, 255))},
                                                           {0.25, QBrush(QColor(102, 0, 255, 255))},
                                                           {0.3, QBrush(QColor(0, 229, 255, 255))}, 
                                                           {0.35, QBrush(QColor(47, 255, 0, 255))},
                                                           {0.4, QBrush(QColor(251, 255, 0, 255))},
							                                              {0.45, QBrush(QColor(255, 0, 0, 255))},
                                                           {0.55, QBrush(QColor(255, 0, 0, 255))}, 
                                                           {0.6, QBrush(QColor(255, 0, 212, 255))},
                                                           {0.65, QBrush(QColor(102, 0, 255, 255))},
                                                           {0.7, QBrush(QColor(0, 229, 255, 255))}, 
                                                           {0.75, QBrush(QColor(47, 255, 0, 255))},
                                                           {0.8, QBrush(QColor(251, 255, 0, 255))},
                                                           {0.85, QBrush(QColor(0, 0, 0, 255))},
                                                           {1.0, QBrush(QColor(0, 0, 0, 255))}}}},

   {19, {"ghost_theme", 4, QColor(165, 165, 165, 40), {{0.3, QBrush(QColor(0, 0, 0, 90))}, 
                                                           {0.4, QBrush(QColor(165, 165, 165, 90))},
                                                           {0.6, QBrush(QColor(0, 0, 0, 90))},
                                                           {0.95, QBrush(QColor(255, 255, 255, 90))}}}},
   
   {20, {"new_theme", 4, QColor(90, 0, 169, 155), {{0.1, QBrush(QColor(37, 0, 51, 255))}, 
							                                            {0.27, QBrush(QColor(0, 0, 0, 255))}, 
							                                            {0.4, QBrush(QColor(191, 31, 255, 255))}, 
							                                            {0.6, QBrush(QColor(51, 214, 255, 255))}, 
							                                            {1.0, QBrush(QColor(37, 0, 51, 255))}}}},

    {21, {"new2_theme", 4, QColor(90, 0, 169, 155), {{0.1, QBrush(QColor(37, 0, 51, 255))}, 
							                                            {0.27, QBrush(QColor(51, 214, 255, 255))}, 
							                                            {0.4, QBrush(QColor(191, 31, 255, 255))}, 
							                                            {0.6, QBrush(QColor(0, 0, 0, 255))}, 
							                                            {1.0, QBrush(QColor(37, 0, 51, 255))}}}},

    {22, {"rev1_theme", 4, QColor(255, 0, 242, 255), {{0.0, QBrush(QColor(255, 0, 242, 255))}, 
                                                  {0.6, QBrush(QColor(255, 0, 170, 255))}, 
                                                  {0.76, QBrush(QColor(255, 0, 170, 255))}, 
                                                  {0.8, QBrush(QColor(255, 0, 242, 255))}, 
                                                  {1.0, QBrush(QColor(255, 0, 170, 255))}}}},

{23, {"rev2_theme", 4, QColor(150, 40, 90, 255), {{0.0, QBrush(QColor(96, 42, 65, 255))}, 
                                                   {0.6, QBrush(QColor(234, 44, 163, 255))}, 
                                                   {0.7, QBrush(QColor(255, 107, 184, 255))},
                                                   {0.8, QBrush(QColor(254, 124, 240, 255))},
                                                   {1.0, QBrush(QColor(234, 44, 163, 255))}}}},

{24, {"rev3_theme", 6, QColor(73, 255, 225, 255), {{0.0, QBrush(QColor(155, 255, 238, 255))}, 
                                                   {0.4, QBrush(QColor(199, 255, 245, 255))}, 
                                                   {0.73, QBrush(QColor(155, 255, 238, 255))},
                                                   {0.9, QBrush(QColor(0, 255, 212, 255))},
                                                   {0.99, QBrush(QColor(155, 255, 238, 255))},
                                                   {1.0, QBrush(QColor(0, 255, 212, 255))}}}},

{25, {"rev4_theme", 4, QColor(37, 48, 91, 255), {{0.0, QBrush(QColor(159, 252, 50, 255))}, 
                                                  {0.4, QBrush(QColor(33, 100, 66, 255))}, 
                                                  {0.7, QBrush(QColor(159, 252, 50, 255))}, 
                                                  {0.8, QBrush(QColor(27, 174, 30, 255))}, 
                                                  {1.0, QBrush(QColor(39, 26, 102, 255))}}}},

{26, {"rev5_theme", 4, QColor(140, 0, 255, 255), {{0.0, QBrush(QColor(53, 255, 235, 255))}, 
                                                  {0.4, QBrush(QColor(0, 0, 0, 255))}, 
                                                  {0.73, QBrush(QColor(227, 104, 249, 255))},
                                                  {0.9, QBrush(QColor(53, 255, 235, 255))},
                                                  {1.0, QBrush(QColor(0, 90, 169, 255))}}}},

{27, {"rev6_theme", 6, QColor(175, 255, 244, 255), {{0.0, QBrush(QColor(175, 255, 244, 255))}, 
                                                    {0.2, QBrush(QColor(240, 255, 163, 255))}, 
                                                    {0.35, QBrush(QColor(255, 247, 0, 255))}, 
                                                    {0.5, QBrush(QColor(180, 255, 238, 255))},
                                                    {0.6, QBrush(QColor(241, 255, 203, 255))},
                                                    {0.7, QBrush(QColor(221, 255, 0, 255))},
                                                    {1.0, QBrush(QColor(0, 115, 255, 255))}}}},

{28, {"rev7_theme", 4, QColor(255, 255, 255, 255), {{0.0, QBrush(QColor(255, 255, 255, 255))}, 
                                                   {0.4, QBrush(QColor(225, 225, 225, 255))}, 
                                                   {0.7, QBrush(QColor(255, 255, 255, 255))}, 
                                                   {0.8, QBrush(QColor(171, 171, 171, 255))}, 
                                                   {1.0, QBrush(QColor(255, 255, 255, 255))}}}},

{29, {"rev8_theme", 4, QColor(7, 52, 61, 255), {{0.0, QBrush(QColor(7, 52, 61, 255))}, 
                                                {0.4, QBrush(QColor(87, 189, 84, 255))}, 
                                                {0.6, QBrush(QColor(63, 148, 77, 255))},
                                                {0.7, QBrush(QColor(35, 101, 69, 255))},
                                                {0.8, QBrush(QColor(21, 77, 65, 255))},
                                                {1.0, QBrush(QColor(116, 239, 92, 255))}}}},

{30, {"rev9_theme", 6, QColor(255, 255, 255, 255), {{0.0, QBrush(QColor(255, 255, 255, 255))}, 
                                                    {0.6, QBrush(QColor(185, 70, 196, 255))}, 
                                                    {0.7, QBrush(QColor(218, 92, 215, 255))},
                                                    {0.8, QBrush(QColor(152, 49, 177, 255))},
                                                    {1.0, QBrush(QColor(255, 255, 255, 255))}}}},

{31, {"rev10_theme", 4, QColor(0, 0, 0, 255), {{0.0, QBrush(QColor(0, 0, 0, 255))},
                                                {0.4, QBrush(QColor(44, 118, 255, 255))},
                                                {0.6, QBrush(QColor(255, 229, 0, 255))},
                                                {0.7, QBrush(QColor(0, 25, 255, 255))},
                                                {0.8, QBrush(QColor(0, 20, 117, 255))},
                                                {1.0, QBrush(QColor(0, 25, 255, 255))}}}},

{32, {"rev11_theme", 4, QColor(255, 255, 255, 255), {{0.0, QBrush(QColor(255, 255, 255, 255))},
                                                    {0.4, QBrush(QColor(255, 253, 203, 255))},
                                                    {0.6, QBrush(QColor(208, 255, 0, 255))},
                                                    {0.7, QBrush(QColor(247, 255, 0, 255))},
                                                    {0.8, QBrush(QColor(118, 118, 0, 255))},
                                                    {1.0, QBrush(QColor(237, 255, 0, 255))}}}},

{33, {"rev12_theme", 6, QColor(44, 0, 39, 255), {{0.0, QBrush(QColor(44, 0, 39, 255))},
                                                 {0.17, QBrush(QColor(132, 14, 118, 255))},
                                                 {0.50, QBrush(QColor(73, 13, 66, 255))},
                                                 {0.71, QBrush(QColor(141, 179, 64, 255))},
                                                 {0.72, QBrush(QColor(255, 255, 255, 255))},
                                                 {0.75, QBrush(QColor(141, 179, 64, 255))},
                                                 {1.0, QBrush(QColor(30, 3, 27, 255))}}}},

{34, {"rev13_theme", 4, QColor(96, 42, 65, 255), {{0.0, QBrush(QColor(96, 42, 65, 255))}, 
                                                  {0.6, QBrush(QColor(150, 40, 90, 255))}, 
                                                  {0.7, QBrush(QColor(234, 44, 163, 255))},
                                                  {0.8, QBrush(QColor(255, 107, 184, 255))},
                                                  {1.0, QBrush(QColor(254, 124, 240, 255))}}}},
                                                  
{35, {"rev14_theme", 4, QColor(0, 0, 0, 255), {{0.0, QBrush(QColor(0, 0, 0, 255))}, 
                                               {0.55, QBrush(QColor(238, 255, 0, 255))},
                                               {0.6, QBrush(QColor(255, 154, 252, 255))},
                                               {0.65, QBrush(QColor(56, 70, 43, 255))},
                                               {0.70, QBrush(QColor(111, 183, 68, 255))},
                                               {1.0, QBrush(QColor(238, 255, 50, 255))}}}},

{36, {"rev15_theme", 6, QColor(0, 0, 0, 255), {{0.0, QBrush(QColor(0, 0, 0, 255))}, 
                                               {0.4, QBrush(QColor(0, 115, 0, 255))}, 
                                               {0.5, QBrush(QColor(45, 165, 45, 255))},
                                               {0.6, QBrush(QColor(0, 133, 0, 255))},
                                               {0.7, QBrush(QColor(0, 171, 0, 255))}, 
                                               {0.8, QBrush(QColor(0, 98, 0, 255))},
                                               {1.0, QBrush(QColor(0, 0, 0, 255))}}}},

{37, {"rev16_theme", 4, QColor(0, 0, 0, 255), {{0.0, QBrush(QColor(0, 0, 0, 255))}, 
                                               {0.52, QBrush(QColor(255, 230, 0, 255))}, 
                                               {0.55, QBrush(QColor(255, 230, 0, 255))},
                                               {0.6, QBrush(QColor(0, 0, 0, 255))},
                                               {0.65, QBrush(QColor(255, 230, 0, 255))}, 
                                               {0.67, QBrush(QColor(255, 230, 0, 255))},
                                               {1.0, QBrush(QColor(255, 230, 0, 255))}}}},

{38, {"rev17_theme", 4, QColor(0, 34, 66, 255), {{0.0, QBrush(QColor(0, 34, 66, 255))}, 
                                                {0.4, QBrush(QColor(0, 67, 154, 255))}, 
                                                {0.6, QBrush(QColor(0, 102, 255, 255))},
                                                {0.75, QBrush(QColor(0, 98, 255, 255))},
                                                {0.8, QBrush(QColor(0, 53, 73, 255))}, 
                                                {0.85, QBrush(QColor(0, 98, 255, 255))},
                                                {1.0, QBrush(QColor(0, 115, 255, 255))}}}},

{39, {"rev18_theme", 6, QColor(0, 0, 0, 255), {{0.0, QBrush(QColor(0, 0, 0, 255))}, 
                                               {0.15, QBrush(QColor(0, 0, 0, 255))}, 
                                               {0.2, QBrush(QColor(255, 251, 0, 255))},
                                               {0.25, QBrush(QColor(255, 47, 0, 255))},
                                               {0.3, QBrush(QColor(255, 0, 229, 255))}, 
                                               {0.35, QBrush(QColor(255, 102, 0, 255))},
                                               {0.4, QBrush(QColor(255, 212, 0, 255))},
                                               {0.45, QBrush(QColor(255, 0, 0, 255))},
                                               {0.55, QBrush(QColor(255, 0, 0, 255))}, 
                                               {0.6, QBrush(QColor(255, 212, 0, 255))},
                                               {0.65, QBrush(QColor(255, 0, 229, 255))},
                                               {0.7, QBrush(QColor(255, 102, 0, 255))}, 
                                               {0.75, QBrush(QColor(255, 47, 0, 255))},
                                               {0.8, QBrush(QColor(255, 251, 0, 255))},
                                               {0.85, QBrush(QColor(0, 0, 0, 255))},
                                               {1.0, QBrush(QColor(0, 0, 0, 255))}}}},

{40, {"rev19_theme", 4, QColor(255, 255, 255, 90), {{0.05, QBrush(QColor(255, 255, 255, 90))}, 
                                                    {0.4, QBrush(QColor(0, 0, 0, 90))}, 
                                                    {0.6, QBrush(QColor(165, 165, 165, 90))},
                                                    {0.7, QBrush(QColor(0, 0, 0, 90))},
                                                    {0.95, QBrush(QColor(0, 0, 0, 90))}}}},
   
    
{41, {"rev20_theme", 4, QColor(37, 0, 51, 255), {{0.0, QBrush(QColor(37, 0, 51, 255))}, 
                                               {0.4, QBrush(QColor(51, 214, 255, 255))}, 
                                               {0.6, QBrush(QColor(191, 31, 255, 255))},
                                               {0.73, QBrush(QColor(0, 0, 0, 255))},
                                               {1.0, QBrush(QColor(37, 0, 51, 255))}}}},
    
{42, {"rev21_theme", 4, QColor(37, 0, 51, 255), {{0.0, QBrush(QColor(37, 0, 51, 255))}, 
                                               {0.4, QBrush(QColor(51, 214, 255, 255))}, 
                                               {0.6, QBrush(QColor(191, 31, 255, 255))},
                                               {0.73, QBrush(QColor(0, 0, 0, 255))},
                                               {1.0, QBrush(QColor(37, 0, 51, 255))}}}}                                                                                                            
