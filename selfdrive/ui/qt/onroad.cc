...
AnnotatedCameraWidget::AnnotatedCameraWidget(VisionStreamType type, QWidget* parent) : fps_filter(UI_FREQ, 3, 1. / UI_FREQ), CameraWidget("camerad", type, true, parent) {
  ...
  themeConfiguration = {
    ...
    {17, {QString("rainbowbridge"), {QColor(255, 0, 0, 255), {{0.0, QBrush(QColor(255, 0, 0, 255))}, {0.2, QBrush(QColor(255, 102, 0, 255))}, {0.4, QBrush(QColor(255, 204, 0, 255))}, {0.6, QBrush(QColor(51, 204, 51, 255))}, {0.8, QBrush(QColor(0, 51, 204, 255))}, {1.0, QBrush(QColor(102, 0, 204, 255))}}}}},
