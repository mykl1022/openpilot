...
AnnotatedCameraWidget::AnnotatedCameraWidget(VisionStreamType type, QWidget* parent) : fps_filter(UI_FREQ, 3, 1. / UI_FREQ), CameraWidget("camerad", type, true, parent) {
  ...
  themeConfiguration = {
    ...
    {16, {QString("volcanotrail"), {QColor(51, 0, 0, 255), {{0.0, QBrush(QColor(102, 0, 0, 255))}, {0.2, QBrush(QColor(204, 0, 0, 255))}, {0.4, QBrush(QColor(255, 51, 0, 255))}, {0.6, QBrush(QColor(204, 0, 0, 255))}, {0.8, QBrush(QColor(102, 0, 0, 255))}, {1.0, QBrush(QColor(83, 73, 29, 255))}}}}},
