...
AnnotatedCameraWidget::AnnotatedCameraWidget(VisionStreamType type, QWidget* parent) : fps_filter(UI_FREQ, 3, 1. / UI_FREQ), CameraWidget("camerad", type, true, parent) {
  ...
  themeConfiguration = {
    {1, {QString("pika_theme"), {QColor(129, 0, 204, 255), {{0.0, QBrush(QColor::fromHslF(59 / 360., 1.0, 0.5, 1.0))},
                                                            {0.2, QBrush(QColor::fromHslF(59 / 360., 1.0, 0.5, 1.0))},
                                                            {0.4, QBrush(QColor::fromHslF(59 / 360., 1.0, 0.0, 1.0))},
                                                            {0.6, QBrush(QColor::fromHslF(59 / 360., 1.0, 0.5, 1.0))},
                                                            {0.8, QBrush(QColor::fromHslF(350 / 360., 1.0, 0.5, 1.0))},
                                                            {1.0, QBrush(QColor::fromHslF(59 / 360., 1.0, 0.5, 1.0))}}}}},
    {2, {QString("aurora_theme"), {QColor(129, 0, 204, 255), {{0.0, QBrush(QColor::fromHslF(304 / 360., 1.0, 0.6, 1.0))},
                                                              {0.2, QBrush(QColor::fromHslF(190 / 360., 1.0, 0.6, 1.0))},
                                                              {0.4, QBrush(QColor::fromHslF(245 / 360., 1.0, 0.4, 1.0))},
                                                              {0.6, QBrush(QColor::fromHslF(245 / 360., 1.0, 0.5, 1.0))},
                                                              {0.8, QBrush(QColor::fromHslF(262 / 360., 1.0, 0.24, 1.0))},
                                                              {1.0, QBrush(QColor::fromHslF(262 / 360., 1.0, 0.24, 1.0))}}}}},
    ...
    {4, {QString("opRnBw_theme"), {QColor(255, 0, 0, 255), {{0.0, QBrush(QColor(75, 0, 0, 255))},
                                                        {0.2, QBrush(QColor(150, 0, 0, 255))},
                                                        {0.4, QBrush(QColor(255, 0, 0, 255))},
                                                        {0.6, QBrush(QColor(0, 150, 0, 255))},
                                                        {0.8, QBrush(QColor(0, 0, 150, 255))},
                                                        {1.0, QBrush(QColor(0, 0, 255, 255))}}}}},
    {5, {QString("rainbow_theme"), {QColor(0, 255, 213, 255), {{0.0, QBrush(QColor::fromHslF(310 / 360., 1.0, 0.5, 1.0))},
                                                               {0.2, QBrush(QColor::fromHslF(25 / 360., 1.0, 0.5, 1.0))},
    ...
    {7, {QString("corn_theme"), {QColor(71, 119, 23, 255), {{0.0, QBrush(QColor::fromHslF(55 / 360., 1.0, 0.50, 1.0))},
                                                            {0.2, QBrush(QColor::fromHslF(19 / 360., 1.0, 0.6, 1.0))},
                                                            {0.4, QBrush(QColor::fromHslF(19 / 360., 1.0, 0.6, 1.0))},
							                                              {0.6, QBrush(QColor::fromHslF(32 / 360., 0.71, 0.96, 1.0))},
						                                                {0.8, QBrush(QColor::fromHslF(32 / 360., 0.71, 0.96, 1.0))},
                                                            {1.0, QBrush(QColor::fromHslF(32 / 360., 0.71, 0.96, 1.0))}}}}},
     {8, {QString("sunset_theme"), {QColor(129, 0, 204, 255), {{0.0, QBrush(QColor::fromHslF(55 / 360., 1.0, 0.5, 1.0))},
                                                               {0.2, QBrush(QColor::fromHslF(24 / 360., 1.0, 0.5, 1.0))},
                                                               {0.4, QBrush(QColor::fromHslF(344 / 360., 0.75, 0.5, 1.0))},
                                                               {0.6, QBrush(QColor::fromHslF(330 / 360., 1.0, 0.35, 1.0))},
                                                               {0.8, QBrush(QColor::fromHslF(277 / 360., 1.0, 0.35, 1.0))},
                                                               {1.0, QBrush(QColor::fromHslF(229 / 360., 1.0, 0.20, 1.0))}}}}},
    {9, {QString("enchantedforest"), {QColor(0, 51, 0, 255), {{0.0, QBrush(QColor(0, 51, 0, 255))},
							                                                {0.2, QBrush(QColor(0, 102, 0, 255))},
							                                                {0.4, QBrush(QColor(0, 51, 0, 255))},
							                                                {0.6, QBrush(QColor(0, 102, 0, 255))},
							                                                {0.8, QBrush(QColor(0, 51, 0, 255))},
							                                                {1.0, QBrush(QColor(0, 51, 0, 255))}}}}},
    {10, {QString("lavaflow"), {QColor(255, 0, 0, 255), {{0.0, QBrush(QColor(51, 0, 0, 255))},
						                                             {0.2, QBrush(QColor(102, 0, 0, 255))},
						                                             {0.4, QBrush(QColor(204, 0, 0, 255))},
						                                             {0.6, QBrush(QColor(255, 102, 0, 255))},
						                                             {0.8, QBrush(QColor(255, 0, 0, 255))},
						                                             {1.0, QBrush(QColor(255, 0, 0, 255))}}}}},
    {11, {QString("underwateradventure"), {QColor(0, 102, 102, 255), {{0.0, QBrush(QColor(0, 51, 102, 255))},
								                                                      {0.2, QBrush(QColor(0, 102, 204, 255))},
								                                                      {0.4, QBrush(QColor(0, 102, 204, 255))},
								                                                      {0.6, QBrush(QColor(0, 51, 102, 255))},
								                                                      {0.8, QBrush(QColor(0, 102, 102, 255))},
								                                                      {1.0, QBrush(QColor(0, 102, 102, 255))}}}}},
    {12, {QString("candyland"), {QColor(255, 85, 85, 255), {{0.0, QBrush(QColor(255, 85, 85, 255))},
							{0.2, QBrush(QColor(255, 170, 85, 255))},
							{0.4, QBrush(QColor(255, 255, 85, 255))},
							{0.6, QBrush(QColor(170, 85, 255, 255))},
							{0.8, QBrush(QColor(85, 85, 255, 255))},
							{1.0, QBrush(QColor(85, 85, 255, 255))}}}}},
    {13, {QString("desert"), {QColor(255, 204, 153, 255), {{0.0, QBrush(QColor(204, 153, 102, 255))},
							    {0.2, QBrush(QColor(255, 204, 153, 255))},
							    {0.4, QBrush(QColor(204, 153, 102, 255))},
							    {0.6, QBrush(QColor(255, 204, 153, 255))},
							    {0.8, QBrush(QColor(204, 153, 102, 255))},
							    {1.0, QBrush(QColor(255, 204, 153, 255))}}}}},
    {14, {QString("icepalace"), {QColor(204, 229, 255, 255), {{0.0, QBrush(QColor(204, 229, 255, 255))},
							  {0.2, QBrush(QColor(153, 204, 255, 255))},
							  {0.4, QBrush(QColor(102, 153, 255, 255))},
							  {0.6, QBrush(QColor(204, 229, 255, 255))},
							  {0.8, QBrush(QColor(153, 204, 255, 255))},
							  {1.0, QBrush(QColor(204, 229, 255, 255))}}}}},
    {15, {QString("hauntedforest"), {QColor(51, 0, 51, 255), {{0.0, QBrush(QColor(0, 0, 0, 255))},
							  {0.2, QBrush(QColor(102, 0, 102, 255))},
							  {0.4, QBrush(QColor(51, 0, 51, 255))},
							  {0.6, QBrush(QColor(102, 0, 102, 255))},
							  {0.8, QBrush(QColor(51, 0, 51, 255))},
							  {1.0, QBrush(QColor(0, 0, 0, 255))}}}}},
    {16, {QString("volcanotrail"), {QColor(51, 0, 0, 255), {{0.0, QBrush(QColor(102, 0, 0, 255))},
							{0.2, QBrush(QColor(204, 0, 0, 255))},
							{0.4, QBrush(QColor(255, 51, 0, 255))},
							{0.6, QBrush(QColor(204, 0, 0, 255))},
							{0.8, QBrush(QColor(102, 0, 0, 255))},
							{1.0, QBrush(QColor(51, 0, 0, 255))}}}}},
    {17, {QString("rainbowbridge"), {QColor(255, 0, 0, 255), {{0.0, QBrush(QColor(255, 0, 0, 255))},
							  {0.2, QBrush(QColor(255, 102, 0, 255))},
							  {0.4, QBrush(QColor(255, 204, 0, 255))},
							  {0.6, QBrush(QColor(51, 204, 51, 255))},
							  {0.8, QBrush(QColor(0, 51, 204, 255))},
							  {1.0, QBrush(QColor(102, 0, 204, 255))}}}}},
    {18, {QString("goldenroad"), {QColor(255, 255, 85, 255), {{0.0, QBrush(QColor(255, 255, 85, 255))},
							  {0.2, QBrush(QColor(255, 255, 170, 255))},
							  {0.4, QBrush(QColor(255, 255, 85, 255))},
							  {0.6, QBrush(QColor(255, 255, 170, 255))},
							  {0.8, QBrush(QColor(255, 255, 85, 255))},
							  {1.0, QBrush(QColor(255, 255, 85, 255))}}}}},
    {19, {QString("dreamycloudscape"), {QColor(173, 216, 230, 255), {{0.0, QBrush(QColor(173, 216, 230, 255))},
								 {0.2, QBrush(QColor(135, 206, 235, 255))},
							         {0.4, QBrush(QColor(0, 191, 255, 255))},
								 {0.6, QBrush(QColor(0, 175, 230, 255))},
								 {0.8, QBrush(QColor(135, 206, 235, 255))},
								 {1.0, QBrush(QColor(173, 216, 230, 255))}}}}},
    {20, {QString("sherbetsunrise"), {QColor(255, 153, 102, 255), {{0.0, QBrush(QColor(255, 153, 102, 255))},
							        {0.2, QBrush(QColor(255, 187, 153, 255))},
								{0.4, QBrush(QColor(255, 221, 187, 255))},
								{0.6, QBrush(QColor(255, 187, 153, 255))},
								{0.8, QBrush(QColor(255, 153, 102, 255))},
								{1.0, QBrush(QColor(255, 153, 102, 255))}}}}},
    {21, {QString("ancientruins"), {QColor(165, 140, 125, 255), {{0.0, QBrush(QColor(165, 140, 125, 255))},
								{0.2, QBrush(QColor(155, 135, 120, 255))},
								{0.4, QBrush(QColor(145, 130, 115, 255))},									
								{0.6, QBrush(QColor(155, 135, 120, 255))},
								{0.8, QBrush(QColor(165, 140, 125, 255))},
								{1.0, QBrush(QColor(165, 140, 125, 255))}}}}},
    {22, {QString("crystalcavern"), {QColor(102, 0, 204, 255), {{0.0, QBrush(QColor(102, 0, 204, 255))},
								{0.2, QBrush(QColor(51, 0, 102, 255))},
								{0.4, QBrush(QColor(102, 0, 204, 255))},
								{0.6, QBrush(QColor(51, 0, 102, 255))},
								{0.8, QBrush(QColor(102, 0, 204, 255))},
								{1.0, QBrush(QColor(102, 0, 204, 255))}}}}},
    {23, {QString("citylights"), {QColor(85, 85, 255, 255), {{0.0, QBrush(QColor(85, 85, 255, 255))},
								{0.2, QBrush(QColor(0, 0, 0, 255))},
								{0.4, QBrush(QColor(255, 85, 85, 255))},
								{0.6, QBrush(QColor(85, 85, 255, 255))},
								{0.8, QBrush(QColor(0, 0, 0, 255))},
								{1.0, QBrush(QColor(85, 85, 255, 255))}}}}},
    {24, {QString("jungleadventure"), {QColor(0, 102, 0, 255), {{0.0, QBrush(QColor(0, 102, 0, 255))},
								{0.2, QBrush(QColor(0, 153, 0, 255))},
								{0.4, QBrush(QColor(0, 204, 0, 255))},
								{0.6, QBrush(QColor(0, 102, 0, 255))},
								{0.8, QBrush(QColor(0, 153, 0, 255))},
								{1.0, QBrush(QColor(0, 102, 0, 255))}}}}},
    {25, {QString("fairytale"), {QColor(255, 153, 204, 255), {{0.0, QBrush(QColor(255, 153, 204, 255))},
								 {0.2, QBrush(QColor(255, 204, 255, 255))},
								 {0.4, QBrush(QColor(153, 204, 255, 255))},
								 {0.6, QBrush(QColor(204, 255, 255, 255))},
								 {0.8, QBrush(QColor(204, 255, 153, 255))},
								 {1.0, QBrush(QColor(255, 153, 204, 255))}}}}},
    {26, {QString("hauntedhouse"), {QColor(51, 0, 51, 255), {{0.0, QBrush(QColor(0, 0, 0, 255))},
								 {0.2, QBrush(QColor(102, 0, 102, 255))},
								 {0.4, QBrush(QColor(51, 0, 51, 255))},
								 {0.6, QBrush(QColor(102, 0, 102, 255))},
								 {0.8, QBrush(QColor(51, 0, 51, 255))},
								 {1.0, QBrush(QColor(0, 0, 0, 255))}}}}},
    {27, {QString("steampunk"), {QColor(139, 69, 19, 255), {{0.0, QBrush(QColor(139, 69, 19, 255))},
								{0.2, QBrush(QColor(205, 133, 63, 255))},
    ...
    // Planets
    {28, {QString("mercury_theme"), {QColor(204, 102, 0, 255), {{0.0, QBrush(QColor(204, 102, 0, 255))}, {0.2, QBrush(QColor(255, 153, 51, 255))}, {0.4, QBrush(QColor(204, 102, 0, 255))}, {0.6, QBrush(QColor(255, 153, 51, 255))}, {0.8, QBrush(QColor(204, 102, 0, 255))}, {1.0, QBrush(QColor(204, 102, 0, 255))}}}}},
