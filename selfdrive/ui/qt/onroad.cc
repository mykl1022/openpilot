...
AnnotatedCameraWidget::AnnotatedCameraWidget(VisionStreamType type, QWidget* parent) : fps_filter(UI_FREQ, 3, 1. / UI_FREQ), CameraWidget("camerad", type, true, parent) {
  ...
  themeConfiguration = {
    {1, {QString("HyLyte"), {QColor(244, 255, 74, 255), {{0.0, QBrush(QColor::fromHslF(64 / 360., 1.0, 0.65, 1.0))}, {0.2, QBrush(QColor::fromHslF(140 / 360., 0.93, 0.59, 1.0))}, {0.4, QBrush(QColor::fromHslF(168 / 360., 1.0, 0.5, 1.0))}, {0.6, QBrush(QColor::fromHslF(64 / 360., 1.0, 0.65, 1.0))}, {0.8, QBrush(QColor::fromHslF(140 / 360., 0.93, 0.59, 1.0))}, {1.0, QBrush(QColor::fromHslF(168 / 360., 1.0, 0.5, 1.0))}}}}},
    {2, {QString("aurora_theme"), {QColor(129, 0, 204, 255), {{0.0, QBrush(QColor::fromHslF(304 / 360., 1.0, 0.6, 1.0))}, {0.2, QBrush(QColor::fromHslF(190 / 360., 1.0, 0.6, 1.0))}, {0.4, QBrush(QColor::fromHslF(245 / 360., 1.0, 0.4, 1.0))}, {0.6, QBrush(QColor::fromHslF(245 / 360., 1.0, 0.5, 1.0))}, {0.8, QBrush(QColor::fromHslF(262 / 360., 1.0, 0.24, 1.0))}, {1.0, QBrush(QColor::fromHslF(262 / 360., 1.0, 0.24, 1.0))}}}}},
    {3, {QString("kirby_theme"), {QColor(255, 153, 213, 255), {{0.0, QBrush(QColor::fromHslF(0 / 360., 1.0, 1.0, 0.9))}, {0.5, QBrush(QColor::fromHslF(330 / 360., 1.0, 0.5, 0.5))}, {1.0, QBrush(QColor::fromHslF(330 / 360., 1.0, 0.5, 0.1))}}}}},
    {4, {QString("opRnBw_theme"), {QColor(255, 0, 0, 255), {{0.0, QBrush(QColor(75, 0, 0, 255))}, {0.2, QBrush(QColor(150, 0, 0, 255))}, {0.4, QBrush(QColor(255, 0, 0, 255))}, {0.6, QBrush(QColor(0, 150, 0, 255))}, {0.8, QBrush(QColor(0, 0, 150, 255))}, {1.0, QBrush(QColor(0, 0, 255, 255))}}}}},
    {5, {QString("rainbow_theme"), {QColor(0, 255, 213, 255), {{0.0, QBrush(QColor::fromHslF(310 / 360., 1.0, 0.5, 1.0))}, {0.2, QBrush(QColor::fromHslF(25 / 360., 1.0, 0.5, 1.0))}, {0.4, QBrush(QColor::fromHslF(60 / 360., 1.0, 0.5, 1.0))}, {0.6, QBrush(QColor::fromHslF(130 / 360., 1.0, 0.5, 1.0))}, {0.8, QBrush(QColor::fromHslF(188 / 360., 1.0, 0.5, 1.0))}, {1.0, QBrush(QColor::fromHslF(265 / 360., 1.0, 0.5, 1.0))}}}}},
    {6, {QString("ocean_theme"), {QColor(0, 255, 213, 255), {{0.0, QBrush(QColor::fromHslF(191 / 360., 0.91, 0.17, 1.0))}, {0.2, QBrush(QColor::fromHslF(209 / 360., 0.44, 0.15, 1.0))}, {0.4, QBrush(QColor::fromHslF(187 / 360., 0.65, 0.42, 1.0))}, {0.6, QBrush(QColor::fromHslF(182 / 360., 0.43, 0.54, 1.0))}, {0.8, QBrush(QColor::fromHslF(182 / 360., 0.26, 0.77, 1.0))}, {1.0, QBrush(QColor::fromHslF(182 / 360., 0.26, 1.0, 1.0))}}}}},
    {7, {QString("corn_theme"), {QColor(71, 119, 23, 255), {{0.0, QBrush(QColor::fromHslF(55 / 360., 1.0, 0.50, 1.0))}, {0.2, QBrush(QColor::fromHslF(19 / 360., 1.0, 0.6, 1.0))}, {0.4, QBrush(QColor::fromHslF(19 / 360., 1.0, 0.6, 1.0))}, {0.6, QBrush(QColor::fromHslF(32 / 360., 0.71, 0.96, 1.0))}, {0.8, QBrush(QColor::fromHslF(32 / 360., 0.71, 0.96, 1.0))}, {1.0, QBrush(QColor::fromHslF(32 / 360., 0.71, 0.96, 1.0))}}}}},
    {8, {QString("sunset_theme"), {QColor(129, 0, 204, 255), {{0.0, QBrush(QColor::fromHslF(55 / 360., 1.0, 0.5, 1.0))}, {0.2, QBrush(QColor::fromHslF(24 / 360., 1.0, 0.5, 1.0))}, {0.4, QBrush(QColor::fromHslF(344 / 360., 0.75, 0.5, 1.0))}, {0.6, QBrush(QColor::fromHslF(330 / 360., 1.0, 0.35, 1.0))}, {0.8, QBrush(QColor::fromHslF(277 / 360., 1.0, 0.35, 1.0))}, {1.0, QBrush(QColor::fromHslF(229 / 360., 1.0, 0.20, 1.0))}}}}},
    {9, {QString("cosmic"), {QColor(67, 27, 62, 255), {{0.0, QBrush(QColor(254, 245, 40, 255))}, {0.2, QBrush(QColor(185, 59, 65, 255))}, {0.4, QBrush(QColor(67, 27, 62, 255))}, {0.6, QBrush(QColor(254, 245, 40, 255))}, {0.8, QBrush(QColor(185, 59, 65, 255))}, {1.0, QBrush(QColor(67, 27, 62, 255))}}}}},
    {10, {QString("Heat"), {QColor(255, 0, 0, 255), {{0.0, QBrush(QColor(85, 0, 150, 255))}, {0.1, QBrush(QColor(102, 0, 0, 255))}, {0.2, QBrush(QColor(204, 0, 0, 255))}, {0.3, QBrush(QColor(255, 102, 0, 255))}, {0.4, QBrush(QColor(255, 0, 0, 255))}, {0.5, QBrush(QColor(85, 0, 150, 255))}}}}},
    {11, {QString("opal"), {QColor(0, 102, 102, 255), {{0.0, QBrush(QColor(230, 210, 255, 255))}, {0.2, QBrush(QColor(255, 214, 180, 255))}, {0.4, QBrush(QColor(160, 253, 255, 255))}, {0.6, QBrush(QColor(232, 214, 255, 255))}, {0.8, QBrush(QColor(254, 255, 210, 255))}, {1.0, QBrush(QColor(255, 215, 155, 255))}}}}},
    {12, {QString("pool"), {QColor(255, 85, 85, 255), {{0.0, QBrush(QColor(0, 0, 0, 255))}, {0.2, QBrush(QColor(0, 85, 90, 255))}, {0.4, QBrush(QColor(0, 250, 250, 255))}, {0.6, QBrush(QColor(255, 255, 255, 255))}, {0.8, QBrush(QColor(255, 255, 255, 255))}, {1.0, QBrush(QColor(0, 0, 0, 255))}}}}},
    {13, {QString("desert"), {QColor(215, 190, 55, 255), {{0.0, QBrush(QColor(0, 0, 0, 255))}, {0.2, QBrush(QColor(71, 46, 0, 255))}, {0.4, QBrush(QColor(179, 141, 64, 255))}, {0.6, QBrush(QColor(255, 211, 78, 255))}, {0.8, QBrush(QColor(255, 219, 147, 255))}, {1.0, QBrush(QColor(83, 73, 29, 255))}}}}},
    {14, {QString("Baja"), {QColor(0, 255, 200, 255), {{0.0, QBrush(QColor(118, 199, 199, 255))}, {0.2, QBrush(QColor(0, 255, 200, 255))}, {0.4, QBrush(QColor(255, 255, 0, 255))}, {0.6, QBrush(QColor(36, 242, 253, 255))}, {0.8, QBrush(QColor(0, 161, 206, 255))}, {1.0, QBrush(QColor(230, 255, 0, 255))}}}}},
    {15, {QString("SunUp"), {QColor(64, 236, 255, 255), {{0.0, QBrush(QColor(0, 0, 0, 255))}, {0.2, QBrush(QColor(71, 46, 0, 255))}, {0.4, QBrush(QColor(179, 141, 64, 255))}, {0.6, QBrush(QColor(255, 211, 78, 255))}, {0.8, QBrush(QColor(255, 219, 147, 255))}, {1.0, QBrush(QColor(83, 73, 29, 255))}}}}},
    {16, {QString("'merica"), {QColor(255, 255, 255, 255), {{0.0, QBrush(QColor(255, 0, 0, 255))}, {0.2, QBrush(QColor(255, 255, 255, 255))}, {0.4, QBrush(QColor(0, 55, 255, 255))}, {0.6, QBrush(QColor(255, 0, 0, 255))}, {0.8, QBrush(QColor(255, 255, 255, 255))}, {1.0, QBrush(QColor(0, 55, 255, 255))}}}}},
    {17, {QString("beach"), {QColor(240, 119, 47, 255), {{0.0, QBrush(QColor(131, 35, 136, 255))}, {0.2, QBrush(QColor(227, 67, 107, 255))}, {0.4, QBrush(QColor(240, 119, 47, 255))}, {0.6, QBrush(QColor(131, 35, 136, 255))}, {0.8, QBrush(QColor(227, 67, 107, 255))}, {1.0, QBrush(QColor(240, 119, 47, 255))}}}}},
    {18, {QString("goldenroad"), {QColor(215, 190, 55, 255), {{0.0, QBrush(QColor(255, 255, 149, 255))}, {0.1, QBrush(QColor(236, 196, 64, 255))}, {0.2, QBrush(QColor(221, 172, 23, 255))}, {0.3, QBrush(QColor(236, 196, 64, 255))}, {0.4, QBrush(QColor(255, 250, 138, 255))}, {0.5, QBrush(QColor(255, 250, 138, 255))}, {0.6, QBrush(QColor(236, 196, 64, 255))}, {0.7, QBrush(QColor(221, 172, 23, 255))}, {0.8, QBrush(QColor(255, 215, 0, 255))}, {0.9, QBrush(QColor(255, 255, 149, 255))}, {1.0, QBrush(QColor(255, 255, 149, 255))}}}}},
    {19, {QString("dreamycloudscape"), {QColor(173, 216, 230, 255), {{0.0, QBrush(QColor(173, 216, 230, 255))}, {0.2, QBrush(QColor(135, 206, 235, 255))}, {0.4, QBrush(QColor(0, 191, 255, 255))}, {0.6, QBrush(QColor(0, 175, 230, 255))}, {0.8, QBrush(QColor(135, 206, 235, 255))}, {1.0, QBrush(QColor(173, 216, 230, 255))}}}}},
    {20, {QString("sherbetsunrise"), {QColor(255, 153, 102, 255), {{0.0, QBrush(QColor(255, 153, 102, 255))}, {0.2, QBrush(QColor(255, 187, 153, 255))}, {0.4, QBrush(QColor(255, 179, 0, 255))}, {0.6, QBrush(QColor(255, 247, 0, 255))}, {0.8, QBrush(QColor(173, 0, 199, 255))}, {1.0, QBrush(QColor(255, 153, 102, 255))}}}}},
    {21, {QString("ancientruins"), {QColor(165, 140, 125, 255), {{0.0, QBrush(QColor(165, 140, 125, 255))}, {0.2, QBrush(QColor(173, 0, 199, 255))}, {0.4, QBrush(QColor(145, 130, 115, 255))}, {0.6, QBrush(QColor(155, 135, 120, 255))}, {0.8, QBrush(QColor(165, 140, 125, 255))}, {1.0, QBrush(QColor(165, 140, 125, 255))}}}}},
    {22, {QString("crystalcavern"), {QColor(102, 0, 204, 255), {{0.0, QBrush(QColor(102, 0, 204, 255))}, {0.2, QBrush(QColor(51, 0, 102, 255))}, {0.4, QBrush(QColor(102, 0, 204, 255))}, {0.6, QBrush(QColor(51, 0, 102, 255))}, {0.8, QBrush(QColor(102, 0, 204, 255))}, {1.0, QBrush(QColor(102, 0, 204, 255))}}}}},
    {23, {QString("citylights"), {QColor(85, 85, 255, 255), {{0.0, QBrush(QColor(85, 85, 255, 255))}, {0.2, QBrush(QColor(0, 0, 0, 255))}, {0.4, QBrush(QColor(255, 85, 85, 255))}, {0.6, QBrush(QColor(85, 85, 255, 255))}, {0.8, QBrush(QColor(0, 0, 0, 255))}, {1.0, QBrush(QColor(85, 85, 255, 255))}}}}},
    {24, {QString("jungleadventure"), {QColor(0, 102, 0, 255), {{0.0, QBrush(QColor(0, 102, 0, 255))}, {0.2, QBrush(QColor(0, 153, 0, 255))},	{0.4, QBrush(QColor(0, 204, 0, 255))}, {0.6, QBrush(QColor(0, 102, 0, 255))},	{0.8, QBrush(QColor(0, 153, 0, 255))},	{1.0, QBrush(QColor(0, 102, 0, 255))}}}}},
    {25, {QString("fairytale"), {QColor(255, 153, 204, 255), {{0.0, QBrush(QColor(255, 153, 204, 255))}, {0.2, QBrush(QColor(255, 204, 255, 255))}, {0.4, QBrush(QColor(153, 204, 255, 255))}, {0.6, QBrush(QColor(204, 255, 255, 255))}, {0.8, QBrush(QColor(204, 255, 153, 255))}, {1.0, QBrush(QColor(255, 153, 204, 255))}}}}},
    {26, {QString("hauntedhouse"), {QColor(102, 0, 153, 255), {{0.0, QBrush(QColor(45, 0, 77, 255))}, {0.2, QBrush(QColor(128, 0, 219, 255))}, {0.3, QBrush(QColor(122, 102, 255, 255))}, {0.4, QBrush(QColor(9, 0, 31, 255))}, {0.6, QBrush(QColor(204, 0, 201, 255))}, {0.7, QBrush(QColor(255, 255, 255, 255))}, {0.8, QBrush(QColor(119, 0, 204, 255))}, {1.0, QBrush(QColor(54, 0, 92, 255))}}}}},
    {27, {QString("steampunk"), {QColor(139, 69, 19, 255), {{0.0, QBrush(QColor(139, 69, 19, 255))}, {0.2, QBrush(QColor(205, 133, 63, 255))}, {0.4, QBrush(QColor(184, 134, 11, 255))}, {0.6, QBrush(QColor(139, 69, 19, 255))}, {0.8, QBrush(QColor(205, 133, 63, 255))}, {1.0, QBrush(QColor(139, 69, 19, 255))}}}}},
    {28, {QString("mercury_theme"), {QColor(77, 77, 77, 255), {{0.0, QBrush(QColor(77, 77, 77, 255))}, {0.2, QBrush(QColor(166, 166, 166, 255))}, {0.4, QBrush(QColor(102, 102, 102, 255))}, {0.6, QBrush(QColor(230, 230, 230, 255))}, {0.8, QBrush(QColor(204, 102, 0, 255))}, {1.0, QBrush(QColor(204, 102, 0, 255))}}}}},
    {29, {QString("venus_theme"), {QColor(255, 26, 0, 255), {{0.0, QBrush(QColor(255, 26, 0, 255))}, {0.2, QBrush(QColor(255, 77, 26, 255))}, {0.4, QBrush(QColor(255, 26, 0, 255))}, {0.6, QBrush(QColor(255, 77, 26, 255))}, {0.8, QBrush(QColor(255, 26, 0, 255))}, {1.0, QBrush(QColor(255, 26, 0, 255))}}}}},
    {30, {QString("earth_theme"), {QColor(0, 26, 255, 255), {{0.0, QBrush(QColor(0, 26, 255, 255))}, {0.2, QBrush(QColor(0, 128, 255, 255))}, {0.4, QBrush(QColor(0, 26, 255, 255))}, {0.6, QBrush(QColor(0, 128, 255, 255))}, {0.8, QBrush(QColor(0, 26, 255, 255))}, {1.0, QBrush(QColor(0, 26, 255, 255))}}}}},
    {31, {QString("mars_theme"), {QColor(204, 0, 0, 255), {{0.0, QBrush(QColor(204, 0, 0, 255))}, {0.2, QBrush(QColor(255, 51, 0, 255))}, {0.4, QBrush(QColor(204, 0, 0, 255))}, {0.6, QBrush(QColor(255, 51, 0, 255))}, {0.8, QBrush(QColor(204, 0, 0, 255))}, {1.0, QBrush(QColor(204, 0, 0, 255))}}}}},
    {32, {QString("jupiter_theme"), {QColor(255, 179, 25, 255), {{0.0, QBrush(QColor(29, 24, 12, 255))}, {0.2, QBrush(QColor(168, 112, 0, 255))}, {0.4, QBrush(QColor(177, 168, 149, 255))}, {0.6, QBrush(QColor(174, 113, 101, 255))}, {0.8, QBrush(QColor(13, 9, 8, 255))}, {1.0, QBrush(QColor(255, 179, 25, 255))}}}}},
    ...
    {37, {QString("Nebula Path"), {QColor(0, 0, 255, 255), {{0.0, QBrush(QColor(0, 0, 255, 255))}, {0.2, QBrush(QColor(0, 0, 255, 255))}, {0.4, QBrush(QColor(0, 255, 255, 255))}, {0.6, QBrush(QColor(0, 255, 0, 255))}, {0.8, QBrush(QColor(255, 255, 0, 255))}, {1.0, QBrush(QColor(255, 0, 0, 255))}}}}},
    {38, {QString("Supernova Trail"), {QColor(255, 255, 0, 255), {{0.0, QBrush(QColor(255, 255, 0, 255))}, {0.1, QBrush(QColor(255, 255, 0, 255))}, {0.3, QBrush(QColor(255, 0, 0, 255))}, {0.5, QBrush(QColor(128, 0, 128, 255))}, {0.7, QBrush(QColor(0, 0, 255, 255))}, {0.9, QBrush(QColor(0, 255, 255, 255))}, {1.0, QBrush(QColor(255, 255, 255, 255))}}}}},
    {39, {QString("Wormhole Vortex"), {QColor(128, 0, 128, 255), {{0.0, QBrush(QColor(128, 0, 128, 255))}, {0.2, QBrush(QColor(255, 0, 255, 255))}, {0.4, QBrush(QColor(0, 255, 255, 255))}, {0.6, QBrush(QColor(0, 255, 0, 255))}, {0.8, QBrush(QColor(255, 255, 0, 255))}, {1.0, QBrush(QColor(255, 0, 0, 255))}}}}},
    {40, {QString("Galactic Rainbow"), {QColor(255, 0, 0, 255), {{0.0, QBrush(QColor(255, 0, 0, 255))}, {0.1, QBrush(QColor(255, 127, 0, 255))}, {0.2, QBrush(QColor(255, 255, 0, 255))}, {0.3, QBrush(QColor(127, 255, 0, 255))}, {0.4, QBrush(QColor(0, 255, 0, 255))}, {0.5, QBrush(QColor(0, 255, 127, 255))}, {0.6, QBrush(QColor(0, 255, 255, 255))}, {0.7, QBrush(QColor(0, 127, 255, 255))}, {0.8, QBrush(QColor(0, 0, 255, 255))}, {0.9, QBrush(QColor(127, 0, 255, 255))}, {1.0, QBrush(QColor(255, 0, 255, 255))}}}}},
    {41, {QString("Liquid Mercury"), {QColor(255, 255, 255, 255), {{0.0, QBrush(QColor(224, 224, 224, 255))}, {0.2, QBrush(QColor(192, 192, 192, 255))}, {0.4, QBrush(QColor(128, 128, 128, 255))}, {0.6, QBrush(QColor(64, 64, 64, 255))}, {0.8, QBrush(QColor(32, 32, 32, 255))}, {1.0, QBrush(QColor(0, 0, 0, 255))}}}}},
    {42, {QString("Polished Silver"), {QColor(192, 192, 192, 255), {{0.0, QBrush(QColor(255, 255, 255, 255))}, {0.2, QBrush(QColor(192, 192, 192, 255))}, {0.4, QBrush(QColor(128, 128, 128, 255))}, {0.6, QBrush(QColor(64, 64, 64, 255))}, {0.8, QBrush(QColor(32, 32, 32, 255))}, {1.0, QBrush(QColor(0, 0, 0, 255))}}}}},
    {43, {QString("Brushed Aluminum"), {QColor(128, 128, 128, 255), {{0.0, QBrush(QColor(255, 255, 255, 255))}, {0.1, QBrush(QColor(192, 192, 192, 255))}, {0.2, QBrush(QColor(160, 160, 160, 255))}, {0.3, QBrush(QColor(128, 128, 128, 255))}, {0.4, QBrush(QColor(96, 96, 96, 255))}, {0.5, QBrush(QColor(64, 64, 64, 255))}, {0.6, QBrush(QColor(32, 32, 32, 255))}, {0.7, QBrush(QColor(0, 0, 0, 255))}, {0.8, QBrush(QColor(32, 32, 32, 255))}, {0.9, QBrush(QColor(64, 64, 64, 255))}, {1.0, QBrush(QColor(96, 96, 96, 255))}}}}},                                                                                                                                                                                                                           
    {44, {QString("Glowing Path"), {QColor(255, 255, 0, 255), {{0.0, QBrush(QColor(255, 255, 0, 255))}, {0.1, QBrush(QColor(255, 255, 0, 255))}, {0.3, QBrush(QColor(255, 255, 0, 255))}, {0.5, QBrush(QColor(255, 255, 0, 255))}, {0.7, QBrush(QColor(255, 255, 0, 255))}, {0.9, QBrush(QColor(255, 255, 0, 255))}, {1.0, QBrush(QColor(255, 255, 0, 255))}}}}}
  };
...
void AnnotatedCameraWidget::drawLaneLines(QPainter &painter, const UIState *s) {
  ...
  if (alwaysOnLateral) {
    pe.setColorAt(0.0, QColor::fromHslF(178 / 360., 0.90, 0.3, 1.0));
    pe.setColorAt(0.5, QColor::fromHslF(178 / 360., 0.90, 0.5, 0.5));
    pe.setColorAt(1.0, QColor::fromHslF(178 / 360., 0.90, 0.5, 0.1));
