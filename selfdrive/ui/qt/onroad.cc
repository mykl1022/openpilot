...
AnnotatedCameraWidget::AnnotatedCameraWidget(VisionStreamType type, QWidget* parent) : fps_filter(UI_FREQ, 3, 1. / UI_FREQ), CameraWidget("camerad", type, true, parent) {
  ...
  themeConfiguration = {
    ...
    {4, {QString("eevee_theme"), {QColor(129, 0, 204, 255), {{0.0, QBrush(QColor::fromHslF(39 / 360., 0.64, 0.93, 1.0))},
                                                             {0.2, QBrush(QColor::fromHslF(39 / 360., 0.64, 0.93, 1.0))},
                                                             {0.4, QBrush(QColor::fromHslF(16 / 360., 0.41, 0.29, 1.0))},
                                                             {0.6, QBrush(QColor::fromHslF(33 / 360., 0.57, 0.64, 1.0))},
                                                             {0.8, QBrush(QColor::fromHslF(33 / 360., 0.57, 0.64, 1.0))},
                                                             {1.0, QBrush(QColor::fromHslF(39 / 360., 0.64, 0.93, 1.0))}}}}},
