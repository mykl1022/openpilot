...
{5, {"kirby_theme", QColor(255, 208, 242, 155), {{0.0, QBrush(QColor(255, 140, 215, 255))},
                                                          {0.1, QBrush(QColor(255, 208, 242, 255))},
							                                            {0.2, QBrush(QColor(255, 181, 230, 255))},
							                                            {0.35, QBrush(QColor(253, 218, 242, 255))},
							                                            {0.5, QBrush(QColor(255, 183, 233, 255))},
...
{7, {"love_theme", QColor(255, 0, 0, 155), {{0.1, QBrush(QColor(0, 0, 0, 255))},
							                                            ...
							                                            {1.0, QBrush(QColor(0, 0, 0, 255))}}}},
{8, {"amethyst_theme", QColor(51, 0, 98, 155), {{0.1, QBrush(QColor(98, 0, 255, 255))},
							                                            {0.27, QBrush(QColor(51, 0, 98, 255))},
							                                            {0.4, QBrush(QColor(132, 0, 255, 255))},
							                                            {0.6, QBrush(QColor(51, 0, 98, 255))},
							                                            {1.0, QBrush(QColor(98, 0, 255, 255))}}}},
...
{11, {"desert_theme", QColor(48, 0, 90, 155), {{0.0, QBrush(QColor(0, 0, 0, 255))},
												    ...
												    {0.4, QBrush(QColor(255, 179, 0, 255))},
							                                            ...
							                                            {1.0, QBrush(QColor(0, 0, 0, 255))}}}},
{12, {"vanilla_theme", QColor(255, 251, 204, 155), {{0.0, QBrush(QColor(211, 207, 153, 255))},
							                                            {0.1, QBrush(QColor(255, 251, 204, 255))},
												    {0.2, QBrush(QColor(255, 249, 229, 255))},
							                                            {0.3, QBrush(QColor(255, 251, 204, 255))},
												    {0.4, QBrush(QColor(255, 248, 221, 255))},
							                                            {0.5, QBrush(QColor(255, 249, 229, 255))},
							                                            {1.0, QBrush(QColor(255, 249, 229, 255))}}}},
