...
ParamController(CustomColors, "CustomColors", "Colors ", "Replace the stock openpilot colors with a custom color scheme.\n\nWant to submit your own color scheme? Post it in the 'feature-request' channel on the FrogPilot Discord!", "../assets/offroad/icon_blank.png",
  ...
  return colors == 0 ? "Stock" : colors == 1 ? "pika" : colors == 2 ? "Aurora" : colors == 3 ? "kirby" : colors == 4 ? "opRnBw" : colors == 5 ? "rainbow" : colors == 6 ? "ocean" : colors == 7 ? "corn" : colors == 8 ? "sunset" : colors == 9 ? "forest" : colors == 10 ? "lavaflow" : colors == 11 ? "undrwtr" : colors == 12 ? "candylnd" : colors == 13 ? "desert" : colors == 14 ? "icey" : colors == 15 ? "haunted" : colors == 16 ? "volcano" : colors == 17 ? "rnbwbridge" : colors == 18 ? "golden" : colors == 19 ? "dreamy" : colors == 20 ? "sherbert" : colors == 21 ? "ruins" : colors == 22 ? "crystal" : colors == 23 ? "citylyts" : colors == 24 ? "jungle" : colors == 25 ? "fairy" : colors == 26 ? "hntdhouse" : colors == 27 ? "steampunk" : colors == 28 ? "mercury" : colors == 29 ? "venus" : colors == 30 ? "earth" : colors == 31 ? "mars" : colors == 32 ? "Jupiter" : colors == 33 ? "Saturn" : colors == 34 ? "Uranus" : colors == 35 ? "Neptune" : "phobos";,
  return v >= 0 ? v % 37 : 36;
)
