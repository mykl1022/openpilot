...
ParamController(CustomColors, "CustomColors", "Colors ", "Replace the stock openpilot colors with a custom color scheme.\n\nWant to submit your own color scheme? Post it in the 'feature-request' channel on the FrogPilot Discord!", "../assets/offroad/icon_blank.png",
  ...
  return colors == 0 ? "Stock" : colors == 1 ? "pika" : colors == 2 ? "Aurora" : colors == 3 ? "kirby" : colors == 4 ? "opRnBw" : colors == 5 ? "rnbw" : colors == 6 ? "ocean" : colors == 7 ? "corn" : colors == 8 ? "sunset" : colors == 9 ? "forest" : colors == 10 ? "Heat" : colors == 11 ? "opal" : colors == 12 ? "pool" : colors == 13 ? "desert" : colors == 14 ? "Baja" : colors == 15 ? "haunted" : colors == 16 ? "volcano" : colors == 17 ? "rnbwbridge" : colors == 18 ? "golden" : colors == 19 ? "dreamy" : colors == 20 ? "sherbert" : colors == 21 ? "ruins" : colors == 22 ? "crystal" : colors == 23 ? "citylyts" : colors == 24 ? "jungle" : colors == 25 ? "fairy" : colors == 26 ? "chrmprpl" : colors == 27 ? "rust" : colors == 28 ? "mercury" : colors == 29 ? "venus" : colors == 30 ? "earth" : colors == 31 ? "mars" : colors == 32 ? "Jupiter" : colors == 33 ? "Saturn" : colors == 34 ? "Uranus" : colors == 35 ? "Neptune" : colors == 36 ?"phobos" : colors == 37 ? "nebula" : colors == 38 ? "nova" : colors == 39 ? "vortex" : colors == 40 ? "galaxy" : colors == 41 ? "lqdmtl" : colors == 42 ? "silver" : colors == 43 ? "almnm" : "glow";,
  return v >= 0 ? v % 45 : 44;
)
