  ...
  while not end_event.is_set():
    ...
    if not params.get_bool("DefaultParamsSet") and params.get("CompletedTrainingVersion") == training_version:
      keys = [
        ...
        "LaneLinesWidth", "RoadEdgesWidth", "PathWidth", "PathEdgeWidth",  "AccelerationPath", "BlindSpotPath", "UnlimitedLength", 
        "DeveloperUI", "DeviceShutdownTimer", "DrivingPersonalitiesUIWheel", "ExperimentalModeViaWheel", "FireTheBabysitter", 
        "DisableAllLogging", "MuteDM", "MuteDoor", "MuteSeatbelt", "MuteSystemOverheat", "LateralTuning", "AverageDesiredCurvature", 
        "NNFF", "LongitudinalTuning", "AccelerationProfile", "IncreasedStoppingDistance", "AggressiveAcceleration", "SmootherBraking", 
        "TSS2Tune", "NudgelessLaneChange", "LaneChangeTimer", "LaneDetection", "OneLaneChange", "NumericalTemp", "RotatingWheel", 
        "ScreenBrightness", "Sidebar", "SilentMode", "SteeringWheel", "TurnDesires", "WideCameraDisable",
      ]
      default_values = {
        "AccelerationPath": "0",
