...
FrogPilotVisualsPanel::FrogPilotVisualsPanel(SettingsWindow *parent) : ListWidget(parent) {
  ...
  for (const auto &[param, title, desc, icon] : visualToggles) {
    ...
    if (param == "CustomTheme") {
      ...
      toggle = new ParamValueControl(param, title, desc, icon, 0, 13, {{0, "Stock"}, {1, "Frog"}, {2, "Tesla"}, {3, "Stalin"}, {4, "Dusk"}, {5, "Hs&Hrs"}, {6, "Lust"}, {7, "Comic"}, {8, "Dawn"}, {9, "Freeze"}, {10, "Night"}, {11, "Gold"}, {12, "Jade"}, {13, "Baja"}}, this);
