...
FrogPilotVisualsPanel::FrogPilotVisualsPanel(SettingsWindow *parent) : FrogPilotListWidget(parent) {
  ...
  for (const auto &[param, title, desc, icon] : visualToggles) {
    ...
    if (param == "AlertVolumeControl") {
      ...
      std::vector<QString> themeOptions{tr("Stock"), tr("Frog"), tr("Tesla"), tr("Stalin"), tr("Icenana"), tr("Kirby"), tr("Night"), tr("Love"), tr("Duck"), tr("Heat"), tr("Blackhole"), tr("Desert"), tr("Bigcat"), tr("Donut"), tr("La"), tr("Ctncandy"), tr("Sunburst"), tr("Nightrider")};
      ...
      std::map<int, QString> steeringWheelLabels = {{-1, "None"}, {0, "Stock"}, {1, "Lexus"}, {2, "Toyota"}, {3, "Frog"}, {4, "Rocket"}, {5, "Hyundai"}, {6, "Stalin"}, {8, "Donut"}, {9, "Donut2"}};
      toggle = new FrogPilotParamValueToggleControl(param, title, desc, icon, -1, 9, steeringWheelLabels, this, true, "", 1, wheelToggles, wheelToggleNames);
